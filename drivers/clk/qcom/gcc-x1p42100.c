...
static struct clk_vdd_class *gcc_x1p42100_regulators[] = {
	&vdd_cx,
	&vdd_mx,
};
...
static struct clk_rcg2 gcc_pcie_0_aux_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = gcc_x1p42100_regulators,
		.num_vdd_classes = ARRAY_SIZE(gcc_x1p42100_regulators),
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOWER] = 19200000},
	},
...
static const struct freq_tbl ftbl_gcc_sdcc1_apps_clk_src[] = {
	...
	F(50000000, P_GCC_GPLL0_OUT_EVEN, 6, 0, 0),
	F(100000000, P_GCC_GPLL0_OUT_EVEN, 3, 0, 0),
	F(192000000, P_GCC_GPLL6_OUT_MAIN, 4, 0, 0),
	F(384000000, P_GCC_GPLL6_OUT_MAIN, 2, 0, 0),
	{ }
};
...
static const struct qcom_reset_map gcc_x1p42100_resets[] = {
	...
	[GCC_VIDEO_XO_CLK_ARES] = { 0x32030, 2 },
};
...
static const struct regmap_config gcc_x1p42100_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_x1p42100_desc = {
	.config = &gcc_x1p42100_regmap_config,
	.clks = gcc_x1p42100_clocks,
	.num_clks = ARRAY_SIZE(gcc_x1p42100_clocks),
	.resets = gcc_x1p42100_resets,
	.num_resets = ARRAY_SIZE(gcc_x1p42100_resets),
	.clk_regulators = gcc_x1p42100_regulators,
	.num_clk_regulators = ARRAY_SIZE(gcc_x1p42100_regulators),
	.gdscs = gcc_x1p42100_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_x1p42100_gdscs),
};

static const struct of_device_id gcc_x1p42100_match_table[] = {
	{ .compatible = "qcom,x1p42100-gcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_x1p42100_match_table);

static int gcc_x1p42100_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &gcc_x1p42100_desc);
	if (IS_ERR(regmap))
	 ...
	 *	gcc_video_xo_clk
	 */
	regmap_update_bits(regmap, 0x4a004, BIT(0), BIT(0));
	regmap_update_bits(regmap, 0x4a014, BIT(0), BIT(0));
...
static void gcc_x1p42100_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &gcc_x1p42100_desc);
}

static struct platform_driver gcc_x1p42100_driver = {
	.probe = gcc_x1p42100_probe,
	.driver = {
		.name = "gcc-x1p42100",
		.of_match_table = gcc_x1p42100_match_table,
		.sync_state = gcc_x1p42100_sync_state,
	},
};

static int __init gcc_x1p42100_init(void)
{
	return platform_driver_register(&gcc_x1p42100_driver);
}
subsys_initcall(gcc_x1p42100_init);

static void __exit gcc_x1p42100_exit(void)
{
	platform_driver_unregister(&gcc_x1p42100_driver);
}
module_exit(gcc_x1p42100_exit);

MODULE_DESCRIPTION("QTI GCC X1P42100 Driver");
MODULE_LICENSE("GPL");
