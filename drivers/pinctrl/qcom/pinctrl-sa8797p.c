...
static const char *const sdc4None_groups[] = {
...
static const struct msm_pingroup sa8797p_groups[] = {
	...
	[169] = PINGROUP(169, tb_trig_sdc4, _, _, _, _, _, _, _, _, _, _, 0,
			 -1),
	[170] = PINGROUP(170, sdc4None, _, _, _, _, _, _, _, _, _, _, 0, -1),
	[171] = PINGROUP(171, sdc4None, _, _, _, _, _, _, _, _, _, _, 0, -1),
	[172] = PINGROUP(172, sdc4None, _, _, _, _, _, _, _, _, _, _, 0, -1),
	[173] = PINGROUP(173, sdc4None, _, _, _, _, _, _, _, _, _, _, 0, -1),
...
static const struct msm_gpio_wakeirq_map sa8797p_pdc_map[] = {
	{ 0, 67 }, { 1, 68 }, { 3, 69 }, { 4, 70 }, { 6, 71 }, { 7, 72 },
	{ 9, 73 }, { 10, 119 }, { 45, 107 }, { 46, 98 }, { 102, 77 }, { 108, 78 },
	{ 110, 120 }, { 114, 80 }, { 116, 81 }, { 120, 117 }, { 124, 108 }, { 126, 99 },
	{ 128, 100 }, { 132, 101 }, { 138, 87 }, { 142, 88 }, { 144, 89 }, { 153, 90 },
